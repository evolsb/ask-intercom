...
class SessionLogger:
    ...
    def info(self, message: str, event: str = "general", service: str = "backend", data: Optional[Dict[str, Any]] = None):
    ...
    def error(self, message: str, event: str = "error", service: str = "backend", 
    ...
    def warning(self, message: str, event: str = "warning", service: str = "backend", 
    ...
    def log_query_complete(self, query: str, result_data: Dict[str, Any], duration_ms: int):
    ...
    def log_api_error(self, service: str, error_type: str, message: str, context: Dict[str, Any]):
...
class SessionManager:
    ...
    def log_session_query(self, session_id: str, query: str, result: Dict[str, Any], duration_ms: int):
